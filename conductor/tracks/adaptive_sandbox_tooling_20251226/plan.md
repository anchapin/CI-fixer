...
- [ ] Task: Enhance `errorClassification.ts` to distinguish between logic failures (exit code 1) and infrastructure failures (exit code 127/command not found) using regex on stderr.
